    ...
    <nav className="relative font-sans text-base border-b border-gray-100">
      <div className="flex justify-between items-center px-4 md:px-10 py-3">
        ...
        <ul className="hidden md:flex justify-center items-center grow list-none mx-5 space-x-8">
          <li>
            <Link href="/" className="text-purple-700 font-bold">
              Home
            </Link>
          </li>

          <li
            className="relative text-gray-800 cursor-pointer flex items-center font-medium"
            ...
            {isDropdownOpen && (
              <ul className="absolute top-full left-0 mt-2 w-56 bg-white border border-gray-200 shadow-lg rounded z-10">
                <li className="px-4 py-2 hover:bg-gray-100">
                  <Link href="/long-term">Long-Term Inquiry Leads</Link>
                </li>
                <li className="px-4 py-2 hover:bg-gray-100">
                  <Link href="/recent-inquiry">Recent Inquiry Leads</Link>
                </li>
                <li className="px-4 py-2 hover:bg-gray-100">
                  <Link href="/fresh-inquiry">Fresh Inquiry Leads</Link>
                </li>
                <li className="px-4 py-2 hover:bg-gray-100">
          ...
          <li>
            <Link href="/hni" className="text-gray-800 font-normal">
              HNI Leads (Acquisition)
            </Link>
          </li>
          <li>
            <Link href="/audience" className="text-gray-800 font-normal">
              Audience Reach Program
            </Link>
          </li>
          <li>
            <Link href="/contact" className="text-gray-800 font-normal">
              Contact Us
            </Link>
          </li>
          <li>
            <Link href="/blog" className="text-gray-800 font-normal">
              Blog
            </Link>
          </li>
        </ul>
        ...
        <ul className="fixed top-16 left-0 w-full bg-white z-50 border-t border-gray-200 shadow-md flex flex-col md:hidden">
          ...
          <li className="px-4 py-3 hover:bg-gray-100" onClick={toggleDropdown}>
            ...
            {isDropdownOpen && (
              <ul className="pl-4">
                <li className="px-4 py-2 hover:bg-gray-100">
                  <Link href="/long-term" onClick={closeMenu}>
                    Long-Term Inquiry Leads
                  </Link>
                </li>
                <li className="px-4 py-2 hover:bg-gray-100">
                  <Link href="/recent-inquiry" onClick={closeMenu}>
                    Recent Inquiry Leads
                  </Link>
                </li>
                <li className="px-4 py-2 hover:bg-gray-100">
                  <Link href="/fresh-inquiry" onClick={closeMenu}>
                    Fresh Inquiry Leads
                  </Link>
                </li>
                <li className="px-4 py-2 hover:bg-gray-100">
                  <Link href="/leadcostcalculator" onClick={closeMenu}>
                    Calculate your Lead Cost
                  </Link>
                </li>
              </ul>
          ...
          <li className="px-4 py-3 hover:bg-gray-100">
            <Link href="/hni" onClick={closeMenu}>
              HNI Leads (Acquisition)
            </Link>
          </li>
          <li className="px-4 py-3 hover:bg-gray-100">
            <Link href="/audience" onClick={closeMenu}>
              Audience Reach Program
            </Link>
          </li>
          <li className="px-4 py-3 hover:bg-gray-100">
